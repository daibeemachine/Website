...
/**
 * pdfjsVersion = 6.0.1169
 * pdfjsBuild = 3e065cc0b
 */
...
async function QuickJSSandbox() {
  let wasmUrl = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : "../web/wasm/";
  const _await$__raw_import__ = await import(
    /*webpackIgnore: true*/
    /*@vite-ignore*/
    `${wasmUrl}quickjs-eval.js`),
    ModuleLoader = _await$__raw_import__.default;
